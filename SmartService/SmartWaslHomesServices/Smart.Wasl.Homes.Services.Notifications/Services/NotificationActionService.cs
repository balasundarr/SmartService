...
{
    public class NotificationsActionService : Service, INotificationsActionService
    {
        public NotificationsActionService(ILogger<NotificationsActionService> paramLogger, IUserInfo paramUserInfo, NotificationsDbContext paramDbContext)
