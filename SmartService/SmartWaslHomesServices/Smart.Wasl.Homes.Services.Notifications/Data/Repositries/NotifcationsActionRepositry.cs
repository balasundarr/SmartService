...
{
    public class NotificationsActionRepositry : Repository, INotificationssActionRepositry
    {
        public NotificationsActionRepositry(IUserInfo paramUserInfo, NotificationsDbContext paramDbContext)
