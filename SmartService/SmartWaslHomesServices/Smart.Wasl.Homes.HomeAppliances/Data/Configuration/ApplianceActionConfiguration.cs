...
namespace Smart.Wasl.Homes.Services.HomeAppliances.Data.Configuration
{
    ...
    {
        public void Configure(EntityTypeBuilder<ApplianceAction> parabuilder)
        {
            //Primary Table
            parabuilder.ToTable("ApplianceAction");
            ...
            parabuilder.Property(p => p.Action).HasColumnType("varchar(255)").IsRequired();
